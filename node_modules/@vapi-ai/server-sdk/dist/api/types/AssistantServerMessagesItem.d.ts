 ...
 */
export type AssistantServerMessagesItem = "conversation-update" | "end-of-call-report" | "function-call" | "hang" | "language-changed" | "language-change-detected" | "model-output" | "phone-call-control" | "speech-update" | "status-update" | "transcript" | "transcript[transcriptType='final']" | "tool-calls" | "transfer-destination-request" | "transfer-update" | "user-interrupted" | "voice-input";
export declare const AssistantServerMessagesItem: {
